...
export const updateDocumentAccess = async ({
  ...
  try {
    ...
    console.log("An error occurred while updating the room access: ", error);
  }
};
...
export const removeCollaborator = async ({
  ...
  try {
    ...
    console.log("An error occurred while removing the collaborator: ", error);
  }
};
...
export const deleteDocument = async (roomId: string) => {
  try {
    ...
    console.log(
      "An error occurred while trying to delete the docuument: ",
      error
    );
  }
};
