    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger>
        <Button className="flex h-9 gap-1 px-4">
          <SquareArrowUpRight />
          <p className="mr-1 hidden sm:block">Manage collaborators</p>
        </Button>
      </DialogTrigger>
      {currentUserType === "creator" ? (
        ...
        <DialogContent className="shad-dialog">
          <DialogHeader>
            <DialogTitle>
              You don't have permission to interact with other collaborators
            </DialogTitle>
            <DialogDescription className="text-secondary-foreground">
              You can remove yourself from the document
            </DialogDescription>
          </DialogHeader>
